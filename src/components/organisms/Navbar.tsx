          ...
          <div className="pointer-events-auto flex items-center justify-between gap-3 py-3 sm:py-4">
            ...
            <div className="flex min-w-0 items-center justify-end gap-2 sm:gap-3">
              ...
              <button
                ...
                className="inline-flex h-10 w-10 items-center justify-center rounded-full border border-white/10 bg-[rgba(20,20,20,0.94)] text-yellow-500 shadow-[0_10px_26px_rgba(0,0,0,0.35)] transition-colors duration-300 hover:bg-[#1b1b1b] lg:hidden"
              >
                <FontAwesomeIcon
                  icon={menuIcon}
                  aria-hidden="true"
