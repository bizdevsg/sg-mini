    ...
    <main>
      ...
      <SectionContainer className="py-16 sm:py-20">
        <div className="grid gap-8 lg:grid-cols-[360px_minmax(0,1fr)]">
          <div className="rounded-[28px] border border-white/10 bg-[rgba(8,8,8,0.78)] p-6 shadow-[0_24px_70px_rgba(0,0,0,0.22)] h-fit">
            {item.imageSrc ? (
              <img
                src={item.imageSrc}
                alt={item.name}
          ...
          <div className="rounded-[28px] border border-white/10 bg-[rgba(8,8,8,0.78)] p-6 shadow-[0_24px_70px_rgba(0,0,0,0.22)] sm:p-8">
            ...
            {item.specsHtml ? (
              <div
                className={[
                  "mt-6 text-sm leading-7 text-zinc-200",
