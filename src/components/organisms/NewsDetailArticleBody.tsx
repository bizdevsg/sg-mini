...
export function NewsDetailArticleBody({ bodyHtml }: NewsDetailArticleBodyProps) {
  return (
    <article
      className={[
        "text-base leading-8 text-gray-200",
        ...
        "[&_li]:leading-8",
        "[&_blockquote]:mb-5 [&_blockquote]:border-l-2 [&_blockquote]:border-yellow-500/40 [&_blockquote]:pl-4 [&_blockquote]:italic [&_blockquote]:text-gray-100",
