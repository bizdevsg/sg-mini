...
export function ClientAreaQuickActionButton({
  ...
  const className =
    "group flex min-h-28 flex-col items-center justify-center rounded-2xl border border-zinc-800 bg-zinc-900/50 p-3 text-center transition-all duration-300 backdrop-blur-sm hover:border-yellow-500/40 hover:bg-zinc-800/60 sm:min-h-32";
  const content = (
    <>
