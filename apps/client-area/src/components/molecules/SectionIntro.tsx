...
export function SectionIntro({
  ...
  return (
    <div className={`${alignmentClassName} ${className}`}>
      ...
      <TitleTag
        className={`mt-5 font-mono text-3xl max-w-4xl mx-auto font-bold capitalize leading-[1.02] tracking-[-0.04em] text-white md:text-4xl lg:text-[2.8rem] ${titleClassName}`}
      >
        {title}
      </TitleTag>
